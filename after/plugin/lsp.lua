...
vim.keymap.set("n", "<Leader>lf", function() vim.lsp.buf.format() end, { desc = "[l]sp format file" })
...
vim.keymap.set("n", "<leader>ls", function() vim.lsp.buf.workspace_symbol() end, { desc = "[l]sp search for symbols" })
vim.keymap.set("n", "<leader>ld", function() vim.diagnostic.open_float() end, { desc = "[l]sp diagnostics" })
...
vim.keymap.set("n", "<leader>li", "<cmd>LspInfo<CR>", { desc = "[l]sp info" })
vim.keymap.set("n", "<leader>ll", "<cmd>LspInfo<CR>", { desc = "[l]sp logs" })
vim.keymap.set("n", "<leader>lr", function() vim.lsp.buf.rename() end, { desc = "[l]sp rename" })
